...
def get_ai_coach():
    ...
    prompt += (
        "\nPlease write the budget coach analysis with one short opening paragraph, "
        "a numbered list of main findings, bullet point action steps under relevant findings, "
        "and a short disclaimer paragraph. Avoid returning one long paragraph."
    )
